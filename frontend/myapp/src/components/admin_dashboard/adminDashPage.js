...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    else if (value.exists && value.type !== "admin") navigate("/login");
  }, []);
  ...
  return (
    <div className="bg-[#171717]">
      ...
      <div className="flex flex-row items-center justify-center mx-auto mt-[75px] pt-6 gap-8 w-9/12">
        <div
          onClick={handleClick}
          className={`bg-[#303030] px-8 py-1 rounded-lg text-white font-[Poppins] w-1/2 hover:bg-blue-900 hover:cursor-pointer ${
            tab ? "bg-blue-900" : "bg-[#303030]"
          }`}
        >
          Task Assign
        </div>
